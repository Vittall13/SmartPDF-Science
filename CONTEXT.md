...
- **Последний рабочий коммит**: 07.02.2026 — `chore: update OCR formula toggle defaults`
...
| 11.03.2026 | Создан CONTEXT.md — точка входа для LLM-сессий (Vibe Framework v4) | Файл добавлен в корень репозитория, коммит с подробным описанием |
| ___.___.___ | | |
